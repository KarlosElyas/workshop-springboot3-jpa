...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception { // metodo e executado assim que inicia a aplicacao
		...
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5)); // pode ser comentada
		
		//COMENTARIOS SÃO IMPORTANTES
		// o SET que é uma collection ta sendo usado para não repetir categorias iguais dentro dele
