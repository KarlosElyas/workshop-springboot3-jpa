...
public class Order implements Serializable {
	...
	@OneToMany(mappedBy = "id.order")// para pegar o order que está dentro do id (PK COMPOSTA)
	private Set<OrderItem> items = new HashSet<>(); //products

	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL) // mesmo id para o payment
